...
$(document).ready(function() {
    $('body').append('<div id="lightbox" style="display:none;position:fixed;top:10px;right:0;width:35%;height:275px;background:rgba(0,0,0,0.0);text-align:center;z-index:9999"></div>');
});
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for ( var i = 0; i < data.length; i++ ) {
                idArray[i] = '<iframe class="vidFrame" width="480" height="270" align="center" src="http://www.youtube.com/embed/' + data[i]['id'] + '?rel=0&showinfo=0&controls=0"> </iframe>';
                console.log( idArray[i] );
            }

            console.log( data.length);
            var htmlString = '<div style="width:5%;position=absolute;text-align:center"> <div style="position:relative;left:25%;width:320px;text-align:left;">';
